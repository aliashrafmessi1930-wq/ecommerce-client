...
const Orders = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      if (!currentUser?.email) return; // 🛑 تأكد إن في مستخدم قبل ما تجيب البيانات
      setLoading(true);
      try {
      ...
      {loading ? (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm max-w-[600px] tracking-wide text-gray-500">
            Here are all your recent purchases and payment details.
          </p>
          ...
          <div className="flex flex-col gap-3">
            <div className="space-y-6 divide-y divide-gray-900/10">
              {orders.map((order, i) => {
                ...
                return (
                  <Disclosure as="div" key={order?.paymentId || i} className="pt-6">
                    {({ open }) => (
                      <>
                        <dt>
