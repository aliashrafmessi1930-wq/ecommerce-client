    ...
    <div className="bg-gray-950 rounded-lg">
      ...
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className={`mt-5 w-full py-2 uppercase text-base font-bold tracking-wide rounded-md duration-200 ${
            loading
              ? "bg-gray-500 text-gray-300 cursor-not-allowed"
              : "bg-indigo-700 text-gray-300 hover:text-white hover:bg-indigo-600"
          }`}
        >
