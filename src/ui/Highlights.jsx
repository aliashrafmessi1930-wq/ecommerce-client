...
const Highlights = () => {
  ...
  console.log(highlightsData); // ✅ شوف لو الصور راجعة فعلاً
...
></div>
          ...
          >
           ...
           <Link
  to={item?._base}
  className="mt-4 w-fit px-5 py-2 text-sm font-semibold rounded-full 
             bg-white/80 text-darkText backdrop-blur-sm
             shadow-md transition-all duration-300
             hover:bg-sky-600 hover:text-white hover:shadow-lg hover:scale-105"
>
  {item?.buttonTitle}
</Link>
